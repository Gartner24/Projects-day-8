...
function operacionesBasicas() {
	let numero1 = prompt('Por favor digite el primer numero: '); //Variable de entrada para el primer numero
	let numero2 = prompt('Por favor digite el segundo numero: '); //Variable de entrada para el segundo numero
